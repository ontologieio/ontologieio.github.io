...
- __Website__ refers to hypha, accessible from [https://www.hypha.network](https://www.hypha.network)
...
- __From Service Providers__. For example, third-party vendors to monitor and analyze the use of our Service, third-party vendors to deliver targeted advertising to You, third-party vendors for payment processing,  or other third-party vendors that We use to provide the Service to You.
...
- By email: privacy@hypha.network
